<div class="row">
    <div class="col-md-8">
        <div class="form-group mb-4">
            ...
            <input type="name" id="vc_nome" name="vc_nome" class="form-control" placeholder="Digite seu nome" value="{{isset($user) ?$user->vc_nome: old('vc_nome') }}">
        </div>
    </div> <!-- /.col -->
</div>
<div class="row">
    <div class="col-md-8">
        <div class="form-group mb-4">
            ...
            <input type="email" id="vc_email" name="vc_email" class="form-control" placeholder="exemplo@gmail.com" value="{{isset($user) ?$user->vc_email: old('vc_email') }}">
        </div>
    </div>
</div>
     <!-- /.col -->
...
<div class="row">
    <div class="col-md-4">
        <div class="form-group mb-2">
            ...
            <input  type="password" id="vc_password" name="vc_password" class="form-control" placeholder="Palavra-passe" value="{{isset($user) ?$user->vc_password: old('vc_password') }}">
        </div>
    </div> <!-- /.col -->
    <div class="form-group mr-3 col-4">
        <label for="vc_classe" class="mr-2 ">Classe</label>
        <select id="vc_classe" aria-placeholder="Sua Classe" name="vc_classe" class="form-control ">
        <option value="" selected disabled>Selecciona a classe</option>
