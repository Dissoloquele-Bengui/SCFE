                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        {{-- <a class="dropdown-item" href="{{route('admin.usuario.edit',['id'=>$user->id])}}">Editar</a> --}}
                                        <a class="dropdown-item" href="{{route('admin.usuario.destroy',['id'=>$user->id])}}">Remover</a>
                                        <a class="dropdown-item" href="{{route('admin.usuario.purge',['id'=>$user->id])}}">Purgar</a>
                                    </div>
                                    </div>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    @include('admin.usuario.edit.index')
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade text-left" id="ModalCreate" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        @include('admin.usuario.create.index')
                        </div>
                    </div>
                </div>
            </div>
